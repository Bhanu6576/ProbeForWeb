...
# Author     : Bhanu
# Tool       : Probeforweb
# Use Script : python3 probefortheweb.py domain.com
# Motive     : Is to available all group of tools to gather information at a single place and Automate the process of manual testing.
